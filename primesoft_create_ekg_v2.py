...
class TagExtractionWorkflow:
    """Complete workflow: Extract tags → Create tagged vector store → Enable search"""
    ...
    def complete_workflow(self, file_mappings: Dict[str, str],
        ...
        print("🏷️  STEP 1: Extracting tags from documents...")
        tag_results = self.extractor.batch_extract_tags(file_mappings, available_tags)

        print("\n📚 STEP 2: Creating tagged vector store...")
        ...
        print("\n🔍 STEP 3: Creating search assistant...")
